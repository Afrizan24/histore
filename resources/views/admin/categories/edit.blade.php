    ...
    <div class="admin-header">
        <div class="admin-header-content">
            <div class="admin-header-left">
                ...
                <p class="admin-subtitle">Update category information and settings</p>
            </div>
    ...
    <div class="form-section">
        <div class="form-card">
            <div class="form-card-header">
                ...
                <p class="form-card-subtitle">Update the details below to modify the category</p>
            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                      ...
                                                      name="description" 
                                                      rows="4" 
                                                      placeholder="Describe what products belong to this category...">{{ old('description', $category->description) }}</textarea>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="stat-item">
                                            ...
                                            <div class="stat-content">
                                                <h6 class="stat-number">{{ $category->products_count }}</h6>
                                    ...
                                    <div class="col-md-6">
                                        <div class="stat-item">
                                            ...
                                            <div class="stat-content">
                                                <h6 class="stat-number">{{ $category->created_at->format('M d, Y') }}</h6>
                                    ...
                                    <div class="image-upload-area" id="imageUploadArea">
                                        @if($category->image)
                                            <div class="image-preview" id="imagePreview">
                                                <img id="previewImage" src="{{ Storage::url($category->image) }}" alt="{{ $category->name }}">
                            ...
                            <div class="form-section-group">
                                ...
                                <div class="preview-card">
                                    ...
                                    <div class="preview-image" id="previewCardImage">
                                        @if($category->image)
                                            <img src="{{ Storage::url($category->image) }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                        @else
                                    ...
                                    <div class="preview-status">
                                        <span class="badge {{ $category->is_active ? 'bg-success' : 'bg-secondary' }}" id="previewStatus">
                            ...
                            <div class="form-section-group">
                                ...
                                <div class="quick-actions">
                                    ...
                                    <button type="button" 
                                            ...
                                            onclick="if(confirm('Are you sure you want to delete this category?')) document.getElementById('deleteForm').submit();">
