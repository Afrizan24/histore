                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select @error('kondisi') is-invalid @enderror" 
                                            ...
                                            <option value="New" {{ old('kondisi', $product->kondisi) == 'New' ? 'selected' : '' }}>Baru</option>
                                            <option value="Second" {{ old('kondisi', $product->kondisi) == 'Second' ? 'selected' : '' }}>Bekas</option>
                                        </select>
                                        @error('kondisi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  name="description" 
                                                  rows="4" 
                                                  placeholder="Deskripsikan detail produk..."
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">
                                        Format: JPG, PNG, GIF. Maksimal 2MB. Kosongkan untuk mempertahankan gambar saat ini.
                                    </small>
                                    @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="card bg-info bg-opacity-10 mt-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <div class="stat-item">
                                                    <h4 class="text-primary mb-1">{{ $product->favorites()->count() }}</h4>
