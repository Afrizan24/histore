...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h3 mb-1">Tambah Produk Baru</h2>
            <p class="text-muted mb-0">Isi informasi produk yang akan ditambahkan</p>
        </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select @error('kondisi') is-invalid @enderror" 
                                            ...
                                            <option value="New" {{ old('kondisi') == 'New' ? 'selected' : '' }}>Baru</option>
                                            <option value="Second" {{ old('kondisi') == 'Second' ? 'selected' : '' }}>Bekas</option>
                                        </select>
                                        @error('kondisi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
